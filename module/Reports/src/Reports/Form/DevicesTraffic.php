...
use Reports\Form\Fieldset\DevicesTraffic as DevicesTrafficFieldset;

class DevicesTraffic extends AbstractForm implements DbModelAwareInterface
{
    /**
    ...
    {
        parent::__construct('devices_traffic_form');
    ...
    {
        $fieldset = new DevicesTrafficFieldset();
